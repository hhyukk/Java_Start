...
다음과 같이 동작해야 한다:
첫 화면에서 사용자에게 세 가지 선택을 제시한다: "1. 상품 등록", "2. 상품 목록", "3. 종료" "1. 상품 등록"을 선택하면,
사용자로부터 상품 이름과 가격을 입력받아 배열에 저장한다. "2. 상품 목록"을 선택하면, 배열에 저장된 모든 상품을 출력한다.
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2:
                    if (productCount < 1) {
                        System.out.println("등록됨 상품이 없습니다.");
                    }
